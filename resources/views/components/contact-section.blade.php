...
<section id="contact" class="bg-white py-16 lg:py-24">
  ...
  <div class="mx-auto max-w-7xl px-6">
    ...
    @if (session('success'))
      <div class="mb-8 rounded-lg bg-green-100 p-4 text-center text-green-800">
        {{ session('success') }}
      </div>
    @endif
        ...
        <form action="{{ route('contact.submit') }}" method="POST">
          ...
          <div class="mb-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <input type="email" name="email" value="{{ old('email') }}" placeholder="e.g. name@example.com"
                required
                class="focus:border-brand focus:ring-brand/30 w-full rounded-lg border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2">
            </div>
            ...
            <div>
              ...
              <input type="tel" name="phone" value="{{ old('phone') }}" placeholder="e.g. +62 812 3456 7890"
                class="focus:border-brand focus:ring-brand/30 w-full rounded-lg border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2">
            </div>
          ...
          <div class="mb-4">
            ...
            <input type="text" name="subject" value="{{ old('subject') }}" placeholder="What is your inquiry about?"
              required
              class="focus:border-brand focus:ring-brand/30 w-full rounded-lg border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2">
          </div>
          ...
          <div class="mb-6">
            ...
            <textarea name="message" rows="4" placeholder="Write your message here..." required
              class="focus:border-brand focus:ring-brand/30 w-full resize-none rounded-lg border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2">{{ old('message') }}</textarea>
          </div>
