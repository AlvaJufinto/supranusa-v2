  ...
  <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    <div>
      ...
      <p class="mt-1 text-sm text-slate-500">
        Update your article content, publishing settings, and SEO information.
      </p>
    </div>

    <a href="{{ route('admin.articles.index') }}"
      class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-slate-50">
      ...
      <div class="space-y-6 xl:col-span-2">
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
          <div class="border-b border-slate-200 px-6 py-4">
            ...
            <p class="mt-1 text-sm text-slate-500">
              Write and edit the main content of your article.
            </p>
          </div>
          ...
          <div class="space-y-5 p-6">
            ...
            <div>
              ...
              <textarea id="excerpt" name="excerpt" rows="3" placeholder="Write a short summary of the article..."
                class="focus:border-brand focus:ring-brand w-full resize-none rounded-lg border border-slate-300 px-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:ring-2">{{ old('excerpt', $article->excerpt) }}</textarea>
            ...
            <div>
              ...
              <textarea id="content" name="content" rows="14"
                ...
                placeholder="Write your article content here..." data-quill-content>{{ old('content', $article->content) }}</textarea>
            </div>
          ...
          <div class="space-y-5 p-6">
            ...
            <div>
              ...
              <input id="meta_title" type="text" name="meta_title"
                value="{{ old('meta_title', $article->meta_title) }}" placeholder="Enter SEO title..."
            ...
            <div>
              ...
              <textarea id="meta_description" name="meta_description" rows="3" placeholder="Enter SEO description..."
                class="focus:border-brand focus:ring-brand w-full resize-none rounded-lg border border-slate-300 px-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:ring-2">{{ old('meta_description', $article->meta_description) }}</textarea>
            ...
            <div>
              ...
              <input id="og_image" type="text" name="og_image" value="{{ old('og_image', $article->og_image) }}"
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <div class="p-5">
            ...
            @if ($article->thumbnail)
              <div class="mb-4 overflow-hidden rounded-lg border border-slate-200 bg-slate-100">
            ...
            @else
              <div
                class="mb-4 flex aspect-video items-center justify-center rounded-lg border-2 border-dashed border-slate-300 bg-slate-50">
            ...
            <label for="thumbnail_file" class="mb-1.5 block text-sm font-medium text-slate-700">
              {{ $article->thumbnail ? 'Replace Thumbnail' : 'Upload Thumbnail' }}
            </label>
