	...
	public function run(): void
	{
		$articles = [
			[
				...
				'status' => 'draft',
				'meta_title' => 'Understanding HVAC Energy Efficiency Standards in Indonesia',
				'meta_description' => 'A comprehensive guide to SNI standards and regulations for commercial HVAC systems in Indonesia.',
				'meta_keywords' => 'HVAC, Understanding, HVAC, Energy, Efficiency',
			],
			[
				...
				'status' => 'draft',
				'meta_title' => 'Cooling Tower Maintenance: A Technical Guide',
				'meta_description' => 'Essential maintenance procedures for industrial cooling towers to ensure optimal performance and longevity.',
				'meta_keywords' => 'HVAC, Cooling, Tower, Maintenance:, A',
			],
			[
				...
				'status' => 'draft',
				'meta_title' => 'Data Center Cooling: Challenges and Solutions',
				'meta_description' => 'How modern data centers are addressing thermal management challenges with innovative HVAC solutions.',
				'meta_keywords' => 'HVAC, Data, Center, Cooling:, Challenges',
			],
			[
				...
				'status' => 'draft',
				'meta_title' => 'The Role of Building Automation in HVAC Optimization',
				'meta_description' => 'How Building Management Systems (BMS) are transforming HVAC operations in commercial buildings.',
				'meta_keywords' => 'HVAC, The, Role, of, Building',
			],
			[
				...
				'status' => 'draft',
				'meta_title' => 'Insulation Materials: Comparing NBR and EPDM for HVAC Applications',
				'meta_description' => 'A technical comparison of NBR and EPDM elastomeric insulation for pipes and ducts.',
				'meta_keywords' => 'HVAC, Insulation, Materials:, Comparing, NBR',
			],
			[
				...
				'status' => 'draft',
				'meta_title' => 'Smart Valves: The Future of HVAC Flow Control',
				'meta_description' => 'Exploring intelligent valve technology and its impact on HVAC system efficiency.',
				'meta_keywords' => 'HVAC, Smart, Valves:, The, Future',
			],
		];
